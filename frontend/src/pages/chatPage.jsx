...
//         </div>
//       </div>
//       <ChatModal inputMessagesRef={inputMessagesRef} chatChannels={chatChannels} 
...
import {
  ...
  useEffect,
  useRef,
} from 'react'; // Добавлена запятая для `comma-dangle`
import {
  useSelector,
  useDispatch,
...
import {
  setSelectedChannelId,
  fetchChannels,
} from '@slices/channelsSlice'; // Добавлена запятая для `comma-dangle`
import { fetchMessages } from '@slices/messagesSlice';
import addImg from '@assets/add-icon.svg';
import MessageForm from '@components/forms/messageForm';
import ChatModal from '@components/chatModal';
